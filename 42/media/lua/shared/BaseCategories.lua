		...
		elseif baseCat and baseCat:contains("Weapon") and not baseCat:contains("Tool") then
		    ...
		    if weapon and instanceof(weapon, "HandWeapon") then
				if weapon:isRanged() then item:DoParam("DisplayCategory", "WepFire")
					...
					local melee
					if categories:contains(WeaponCategory.AXE) then	melee = "WepMAxe"
					elseif categories:contains(WeaponCategory.BLUNT) then melee = "WepMBluntL"
					elseif categories:contains(WeaponCategory.SMALL_BLUNT) then melee = "WepMBluntS"
					elseif categories:contains(WeaponCategory.LONG_BLADE) then melee = "WepMBladeL"
...
local function BSboot()
	...
	for _, category in ipairs(BSoverride) do BSnewCat(category.items, category.category)
	end
end
